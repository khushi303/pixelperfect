    ...
    return (
        <>
            <div className="container mx-auto max-w-[1164px] px-3 pt-[60px]">
                <h2 className="ff_mazzardregular lg:text-[52px] sm:text-[32px] text-[20px] font-semibold text-white leading-[110%] text-center mb-3">{props.ServiveHeading}</h2>
                <p className='lg:text-[16px] sm:text-[14px] text-[12px] font-normal leading-[150%] text-white opacity-80 text-center mt-[12px] mb-[60px]'>{props.Para1} <span className='md:block'>online assets are safe and your reputation intact.</span></p>
