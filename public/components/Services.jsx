...
export default function Services(props) {
    return (
        <div className='relative'>
            <div className="container mx-auto xl:max-w-[1164px] lg:px-3 md:px-10 px-6 lg:pt-[140px] md:pt-[80px] pt-[60px] xl:pb-[170px] lg:pb-[130px] md:pb-[100px] pb-[80px] relative z-10">
            ...
            <div className='w-[167px] h-[167px] bg-[#00BCD4] absolute bottom-0 right-[-140px] blur-[300px]'></div>
        </div>
    )
}
